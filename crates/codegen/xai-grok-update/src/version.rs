...
/// GitHub repo used by the `gh-release` installer path.
///
/// This fork publishes to liminal-ai/grok-build-lhc (not xAI's CDN/repo).
pub const GH_RELEASE_REPO: &str = "liminal-ai/grok-build-lhc";
